...
"Load fluxnet data"
nc_f = '/home/ahmad/Projects/deepCause/datasets/ncdata/DE-Hai.2000.2006.hourly.nc'  # Your filename
...
prediction_length = 15  # data for 3 days
...
test_data = common.ListDataset(
    [
        ...
        'dynamic_feat': [temp[start:test_stop], rg[start:test_stop], 
        vpd[start:test_stop]],
        }
    ],
    freq=freq)

trainer = Trainer(epochs=epochs, hybridize=False)
...
forecast_it, ts_it = make_evaluation_predictions(
    ...
    num_samples=prediction_length,  # number of sample paths for evaluation
)
...
print('forecast shape: ', np.shape(forecasts))
tss = list(ts_it)
