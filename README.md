...
4.  For each pair variables {<img src="https://render.githubusercontent.com/render/math?math=z_i">, <img src="https://render.githubusercontent.com/render/math?math=z_j">} in nonlinear system, we apply hypthosis test on the mean of the residuals distribution $M_{res}$ of counterfactuals for multiple realization of the time series.
